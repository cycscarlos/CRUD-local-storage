...
Este proyecto consiste en la creación de un aplicación tipo CRUD (Create, Replace, Update, and Delete), solo que la data ingresada por el usuario será almacenada en el Local Storage del navegador (y no en una Base de Datos, como comunmente ocurre). Esto permite que aunque la aplicación sea cerrada, la data aún permanecerá en la memoria del Browser. Desarrollado en HTML, CSS y JAVASCRIPT.
